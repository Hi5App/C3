...
import static tv.danmaku.ijk.media.example.fragments.FileListFragment.newInstance;
...
public class FileExplorerActivity extends AppActivity {
    ...
    private void doOpenDirectory(String path, boolean addToBackStack) {
        Fragment newFragment = newInstance(path);

        FragmentTransaction  transaction = getSupportFragmentManager().beginTransaction();


        transaction.replace(R.id.body,newFragment,null);
