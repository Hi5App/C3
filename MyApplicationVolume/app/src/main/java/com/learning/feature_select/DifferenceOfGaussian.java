...
public class DifferenceOfGaussian {
    public static void filter3d(float sigma, int[] inPixels, int[] outPixels,
        ...
        GaussianBlur.convolveAndTranspose(g1.getKernel(),inPixels,out1,weight,height,depth,edgeAction);
        GaussianBlur.convolveAndTranspose(g2.getKernel(),inPixels,out2,weight,height,depth,edgeAction);
