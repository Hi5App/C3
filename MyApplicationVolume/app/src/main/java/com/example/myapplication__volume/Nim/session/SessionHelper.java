...
import com.example.myapplication__volume.Nim.session.extension.SnapChatAttachment;
import com.example.myapplication__volume.Nim.session.extension.StickerAttachment;
import com.example.myapplication__volume.Nim.session.search.SearchMessageActivity;
...
import com.example.myapplication__volume.Nim.session.viewholder.MsgViewHolderTip;
