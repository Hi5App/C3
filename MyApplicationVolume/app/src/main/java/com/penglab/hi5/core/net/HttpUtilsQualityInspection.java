...
public class HttpUtilsQualityInspection extends HttpUtils{
    private static final String URL_GET_ARBOR = SERVER_IP + "/release/arbor/getarbor";
    private static final String URL_QUERY_ARBOR_RESULT = SERVER_IP + "/release/arbor/queryarborresult";
    private static final String URL_UPDATE_ARBOR_RESULT = SERVER_IP + "/release/arbor/updatearborresult";
...
//    private static final String URL_GET_ARBOR_MARKER_LIST = SERVER_IP + "/dynamic/arbor/queryarborresult";
    private static final String URL_QUERY_ARBOR_MARKER_LIST = SERVER_IP + "/release/arbordetail/query";
    private static final String URL_INSERT_ARBOR_MARKER_LIST = SERVER_IP + "/release/arbordetail/insert";
    private static final String URL_DELETE_ARBOR_MARKER_LIST = SERVER_IP + "/release/arbordetail/delete";
