...
import com.penglab.hi5.core.net.HttpUtilsBoutonDetection;
...
public class BoutonDetectionDataSource {
    ...
    private final String TAG = "BoutonDetectionDataSource";
    ...
    public void getArbor(int MaxId) {
        try {
            ...
            HttpUtilsBoutonDetection.getArborWithOkHttp(userInfo, MaxId,new Callback() {
                @Override
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (responseCode == 200) {
                        ...
                        try {
                            ...
                            Log.e(TAG,"bouton_arborInfoList"+arborInfoList.toString());
    ...
    public void getSwc(String res, float offsetX,float offsetY,float offsetZ,int size,String arborName){
        try{
            ...
            JSONObject userInfo = new JSONObject().put("name", InfoCache.getAccount()).put("passwd", InfoCache.getToken());
            HttpUtilsBoutonDetection.getSwcWithOkHttp(userInfo,bBox, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
    ...
    public void queryArborResult(int arborId) {
        try{
            JSONObject userInfo = new JSONObject().put("name", InfoCache.getAccount()).put("passwd", InfoCache.getToken());
            HttpUtilsBoutonDetection.queryArborResultWithOkHttp(userInfo, arborId, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
    ...
    public void updateArborResult(int arborId, int result, String username) {
        try{
            ...
            JSONObject userInfo = new JSONObject().put("name", InfoCache.getAccount()).put("passwd", InfoCache.getToken());
            HttpUtilsBoutonDetection.updateSingleArborResultWithOkHttp(userInfo, arborId, result, username, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
    ...
    private void insertArborMarkerList(JSONArray insertList, JSONObject userInfo) {
        try{
            HttpUtilsBoutonDetection.insertArborMarkerListWithOkHttp(userInfo, insertList, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
    ...
    private void deleteArborMarkerList(JSONArray deleteList, JSONObject userInfo) {
        try{
            HttpUtilsBoutonDetection.deleteArborMarkerListWithOkHttp(userInfo, deleteList, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
    ...
    public void queryArborMarkerList(int arborId) {
        try{
            ...
            JSONObject userInfo = new JSONObject().put("name", InfoCache.getAccount()).put("passwd", InfoCache.getToken());
            HttpUtilsBoutonDetection.queryArborMarkerListWithOkHttp(userInfo, arborId, new Callback() {
                @Override
                public void onFailure(Call call, IOException e) {
