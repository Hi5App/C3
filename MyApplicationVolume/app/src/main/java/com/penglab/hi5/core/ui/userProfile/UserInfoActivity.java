...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private ItemGroup ig_id,ig_nickname,ig_gender,ig_region;
    ...
    private CircleImageView ri_portrati;
...
//        ri_portrati = (CircleImageView) findViewById(R.id.HeadView);
//
//        ig_nickname.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//            }
//        });
//        ig_region.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//            }
...
//            public void onClick(View v) {
////                loggedInUser.update();
//                Toast.makeText(UserInfoActivity.this, "Save successfully",Toast.LENGTH_SHORT).show();
//                finish();
//            }
//        });
...
////                        loggedInUser.setPortrait(photoUtils.bitmap2byte(bitmap));
...
////                    loggedInUser.setPortrait(photoUtils.bitmap2byte(bitmap));
//                } else {
//                    Log.d("food", "Not found the picture");
//                }
//                break;
//            //如果是编辑名字，则修改展示
//            case EDIT_NAME:
//                if (resultCode == RESULT_OK) {
//                    ig_nickname.getContentEdt().setText(loggedInUser.getNickName());
//                }
//                break;
//            default:
//                break;
...
//        ig_id.getContentEdt().setText(loginUser.getUserId());  //ID是int，转string
//        ig_nickname.getContentEdt().setText(loginUser.getNickName());
